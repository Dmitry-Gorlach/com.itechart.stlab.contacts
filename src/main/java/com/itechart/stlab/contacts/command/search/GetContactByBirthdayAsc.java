...
public class GetContactByBirthdayAsc implements Command {
    private static final String PAGE_CONTACTS_LIST = "page.contacts.list";
    private ContactLogic contactLogic;

    public GetContactByBirthdayAsc(ContactLogic contactLogic) {
    ...
    public Router execute(HttpServletRequest request) throws LogicException {
        ...
        List<Contact> contacts = contactLogic.findContactByBirthdayAsc(LocalDate.parse(birthday));
